 ...
 * @param {Boolean} debug - From cli, indicates if the application is running w/ debugging mode
 * @param {'id'|'title'|undefined} type='title' - From cli. The Output type, 'title' by default
 * @param {Array<ParsedDiff>} diffsArr - Parsed diff array from generate-line-output#generateConsoleOutput
 * @see lib/generate-line-output.js
 * @returns {Void}
 */
